...
actionButton(inputId='run_plot', label = 'Plot the data.', width = '100%'),
                      ...
                      div(id = 'outliers_plot',
                          tags$hr(style="border-color: black;"),
                          h4('Outliers'),
                          p("This is used to quickly adjust the plots by removing/replacing/limiting 'outliers' to allow for a generalized observation of the data. In an analysis, outlier detection and handling <b>must be justified</b>."),
